...
export const translations = {
  en: {
    ...
    marketRequests: {
      ...
      target: 'Directed to',
      suppliersOnly: 'Distributors Only',
      ...
      myPosts: 'My Requests',
      filterSuppliers: 'For Distributors',
    ...
    productSearch: {
      ...
      subtitle: 'Source industrial materials across all verified global distributors.',
      viewProducts: 'Global Products',
      viewSuppliers: 'By Distributor',
    ...
    products: {
      ...
      duplicateNameError: 'A product with this name already exists for this distributor',
    ...
    register: {
      ...
      supplierDesc: 'Distributing materials and responding to requests.',
    ...
    construction: {
      ...
      supplierTitle: 'Distributor Portal',
  ...
  ar: {
    ...
    manualOrder: {
      ...
      subtitle: 'اطلب منتجاً غير مدرج في الكتالوج الخاص بهذا الموزع',
      prodName: 'اسم المنتج',
      origin: 'بلد المنشأ',
      qty: 'الكمية المطلوبة',
    ...
    productSearch: {
      title: 'اكتشاف السوق',
      subtitle: 'ابحث عن المواد الصناعية من جميع الموزعين المعتمدين عالمياً.',
      viewProducts: 'جميع المنتجات',
      viewSuppliers: 'حسب الموزع',
    ...
    products: {
      ...
      duplicateNameError: 'منتج بهذا الاسم موجود بالفعل لهذا الموزع',
    ...
    register: {
      ...
      supplier: 'موزع',
      supplierDesc: 'توزيع المواد والرد على الطلبات.',
      ...
      orgName: 'اسم المؤسسة',
      orgCRN: 'رقم البطاقة الضريبية',
      orgCRNImage: 'صورة البطاقة الضريبية',
      emailPlaceholder: 'email@example.com',
      phonePlaceholder: 'مثال: 01xxxxxxxxx',
    ...
    landing: {
      ...
      heroSubtitle: 'بوابتك المتكاملة للربط بين العملاء والموزعين في القطاع الدوائي بذكاء وسرعة فائقة.',
      signIn: 'تسجيل الدخول',
    ...
    profileExtra: {
      ...
      crnNumber: 'رقم البطاقة الضريبية',
      ...
      pointsLabel: 'النقاط',
      registrationCertificate: 'شهادة البطاقة الضريبية',
      previewDocument: 'تكبير الصورة',
      noCrnDocument: 'لا توجد صورة بطاقة ضريبية',
      saveAd: 'حفظ الإعلان',
